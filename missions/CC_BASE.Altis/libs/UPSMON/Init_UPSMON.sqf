...
UPSMON_searchVehicledist = 1000; // 600, 900
...
if ( UPSMON_SURRENDER ) then
{
	...
	"UPSMON_EAST_SURRENDED" addPublicVariableEventHandler { if (_this select 1) then { nul=[east] execvm "libs\UPSMON\UPSMON\MODULES\UPSMON_surrended.sqf";};};
	"UPSMON_WEST_SURRENDED" addPublicVariableEventHandler { if (_this select 1) then { nul=[west] execvm "libs\UPSMON\UPSMON\MODULES\UPSMON_surrended.sqf";};};
	"UPSMON_GUER_SURRENDED" addPublicVariableEventHandler { if (_this select 1) then { nul=[resistance] execvm "libs\UPSMON\UPSMON\MODULES\UPSMON_surrended.sqf";};};
...
//----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
	...
	if (isNil("UPSMON_INIT") || UPSMON_INIT == 0) then {
		...
		// global functions
		call compile preprocessFileLineNumbers "libs\UPSMON\UPSMON\COMMON\UPSMON_KRON_FNC.sqf";
		call compile preprocessfile "libs\UPSMON\UPSMON\Get_pos\UPSMON_pos_init.sqf";

		//Init library function, Required Version: 5.0 of mon_functions
		call compile preprocessFileLineNumbers "libs\UPSMON\UPSMON\COMMON\MON_functions.sqf";

		//init !R functions
		call compile preprocessFileLineNumbers "libs\UPSMON\UPSMON\COMMON\UPSMON_R_FNC.sqf";

		//init Aze Functions
		call compile preprocessFileLineNumbers "libs\UPSMON\UPSMON\COMMON\UPSMON_Aze_FNC.sqf";
		call compile preprocessFileLineNumbers "libs\UPSMON\UPSMON\COMMON\func_getcover.sqf";

		// Init Modules
		call compile preprocessFileLineNumbers "libs\UPSMON\UPSMON\MODULES\UPSMON_AMBUSH.sqf";
		call compile preprocessFileLineNumbers "libs\UPSMON\UPSMON\MODULES\UPSMON_CLONES.sqf";
		call compile preprocessFileLineNumbers "libs\UPSMON\UPSMON\MODULES\UPSMON_FORTIFY.sqf";
		call compile preprocessFileLineNumbers "libs\UPSMON\UPSMON\MODULES\UPSMON_MOVEMENT.sqf";
		call compile preprocessFileLineNumbers "libs\UPSMON\UPSMON\MODULES\UPSMON_RESPAWN.sqf";
		call compile preprocessFileLineNumbers "libs\UPSMON\UPSMON\MODULES\UPSMON_RENF.sqf";
		call compile preprocessFileLineNumbers "libs\UPSMON\UPSMON\MODULES\UPSMON_ARTILLERYMOD.sqf";
		call compile preprocessFileLineNumbers "libs\UPSMON\UPSMON\MODULES\UPSMON_ORDERS.sqf";

		[] execVM "libs\UPSMON\UPSMON\UPSMON_MAINLOOP.sqf";
		If (UPSMON_DEBUG > 0) then {[] execvm "libs\UPSMON\UPSMON\MODULES\UPSMON_TRACK.sqf";};

		//init SunAngle Functions
		call compile preprocessFileLineNumbers "libs\UPSMON\UPSMON\SunAngle_fnc.sqf";

		//scripts initialization
		UPSMON = compile preprocessFile "libs\UPSMON\UPSMON.sqf";
	...
	// ***********************************************************************************************************
		UPSMON_MAIN_server =
		{
			...
			while {true} do
			{
				...
				//diag_log format ["UPSMON_REINFORCEMENT_WEST_UNITS: [%1]", UPSMON_REINFORCEMENT_WEST_UNITS];
				//diag_log format ["UPSMON_REINFORCEMENT_EAST_UNITS: [%1]", UPSMON_REINFORCEMENT_EAST_UNITS];
				//diag_log format ["UPSMON_REINFORCEMENT_GUER_UNITS: [%1]", UPSMON_REINFORCEMENT_GUER_UNITS];
				sleep _cycle;
			};
		};
	};
